            ...
            <main class="col-xl-10 col-lg-9 col-12 m-xl-0 m-lg-0 m-0 order-lg-2 order-1">
                ...
                <div class="mainImage flex-fill">
                    ...
                    <div class="flex-row mt-3 d-flex justify-content-between">
                        ...
                        @auth
                            @can("createReport", Auth::user())
                        <div>
                            <button class="btn mx-3 btn-outline-danger" data-bs-toggle="modal" data-bs-target="#reportDialogModal">
                                <span class="spinner-border fs-3 d-none" aria-hidden="true"></span>
                                ...
                                <div>
                                    <form method="post" action="{{route("report.img")}}" enctype="multipart/form-data">
                                        @csrf
                                        @method("post")

                                        <input type="hidden" name="imageID" value="{{$submission->getImage()->id}}">

                                        <!-- dialog -->
                                        <div class="modal fade" id="reportDialogModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <label for="reason">Dvovod reportu:</label>
                                                        <textarea name="reason" class="form-control" id="reasonTextAr" rows="3"></textarea>
                                                    </div>
